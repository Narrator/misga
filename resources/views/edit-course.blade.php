        ...
        <div class="content container">
            <div class="page-wrapper">
                <header class="page-heading clearfix">
                    <h1 class="heading-title pull-left">Edit Course</h1>
                ...
                <div class="page-content">
                    <div class="row">
                        <article class="contact-form col-md-8 col-sm-7  page-row">
                            <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"  action="/handle-edit-course/{{ $course->id }}" novalidate>
                                {{ method_field('PATCH') }}
                                ...
                                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="title" type="text" class="form-control" name="title" value="{{ $course->title }}" autofocus>
                                    @if ($errors->has('title'))
                                ...
                                <div class="form-group{{ $errors->has('start-date') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="start-date" type="text" class="form-control datepicker" name="start-date" value="{{ $course->{'start-date'} }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('duration') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="duration" type="text" class="form-control" name="duration" value="{{ $course->duration }}" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="location" type="text" class="form-control" name="location" value="{{ $course->location }}" autofocus>
                                ...
                                <div class="form-group semester">
                                    ...
                                    <select class="form-control" id="semester" name="semester">
                                        <option {{ $course->semester == 'spring' ? 'selected="selected"' : '' }} value="spring">Spring</option>
                                        <option {{ $course->semester == 'summer' ? 'selected="selected"' : '' }} value="summer">Summer</option>
                                        <option {{ $course->semester == 'fall' ? 'selected="selected"' : '' }} value="fall">Fall</option>
                                    </select>
                                </div><!--//form-group-->
