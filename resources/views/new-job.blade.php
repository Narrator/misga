                ...
                <div class="page-content">
                    <div class="row">
                        <article class="contact-form col-md-8 col-sm-7  page-row">
                            <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"  action="/add-job" novalidate>
                                ...
                                <div class="form-group{{ $errors->has('department') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="department" type="text" class="form-control" name="department" placeholder="Enter the department" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('salary') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="salary" type="text" class="form-control" name="salary" placeholder="Enter the salary" autofocus>
                                ...
                                <div class="form-group{{ $errors->has('closing-date') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="closing-date" type="text" class="form-control" name="closing-date" placeholder="Enter the Closing date" autofocus>
