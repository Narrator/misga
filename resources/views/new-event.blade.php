                ...
                <div class="page-content">
                    <div class="row">
                        <article class="contact-form col-md-8 col-sm-7  page-row">
                            <form class="form-horizontal" role="form" method="POST" enctype="multipart/form-data"  action="/add-event" novalidate>
                                ...
                                <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="date" type="text" class="form-control" name="date" placeholder="Enter the date" autofocus>
                                    @if ($errors->has('date'))
                                        <span class="help-block" style="text-align:left; width:100%; margin-bottom: 0">
                                ...
                                <div class="form-group{{ $errors->has('time') ? ' has-error' : '' }}" style="margin-bottom: 10px">
                                    ...
                                    <input id="time" type="text" class="form-control" name="time" placeholder="Enter the time" autofocus>
                                    @if ($errors->has('time'))
                                        <span class="help-block" style="text-align:left; width:100%; margin-bottom: 0">
